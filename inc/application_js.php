...
if ($loggedin) {
    ...
    $lang = $user->get_var_default('lang',Settings::get_default('LANGUAGE','EN'));
} else {
    // Get the system's language preference, or default to English
    $lang = Settings::get_default('LANGUAGE','EN');
}

// public only need the 'login' page
$public = array('ext/src/locale/ext-lang-'.strtolower($lang).'.js','Mico.Application.js',
                "lang/Mico.Lang.".$lang.".js",'Mico.Footer.js','Mico.Login.js');
// standard scipts for users
$authed = array('ext/src/locale/ext-lang-'.strtolower($lang).'.js','Mico.Application.js',
                "lang/Mico.Lang.".$lang.".js",'Mico.Footer.js','Mico.SystemMenu.js',
...
$manager = array('ext/src/locale/ext-lang-'.strtolower($lang).'.js','Mico.Application.js',
                 "lang/Mico.Lang.".$lang.".js",'Mico.Footer.js','Mico.SystemMenu.js',
                 'Mico.Calls.js','Mico.Calls.AddCall.js','Mico.Calls.ViewCalls.js',
...
$admin = array('ext/src/locale/ext-lang-'.strtolower($lang).'.js','Mico.Application.js',
               "lang/Mico.Lang.".$lang.".js",'Mico.Footer.js','Mico.SystemMenu.js',
               'Mico.Calls.js','Mico.Calls.AddCall.js','Mico.Calls.ViewCalls.js',
...
$passreset = array('ext/src/locale/ext-lang-'.strtolower($lang).'.js','Mico.Application.js',
                   "lang/Mico.Lang.".$lang.".js",'Mico.Footer.js','Mico.PasswordSet.js',
                   'Mico.Utils.js');
